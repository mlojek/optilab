...
class TestBounds:
    ...
    def test_valid_bounds(self):
        ...
        """
        bounds_object = Bounds(lower=-100, upper=100)
    ...
    def test_point_in_bounds_1d(self):
        ...
        """
        bounds_object = Bounds(lower=-100, upper=100)
        simple_point = Point(x=np.array([10]))
    ...
    def test_point_in_bounds_1d_equal(self):
        ...
        """
        bounds_object = Bounds(lower=-100, upper=100)
        simple_point = Point(x=np.array([100]))
        assert simple_point in bounds_object
    ...
    def test_point_in_bounds_5d(self):
        ...
        """
        bounds_object = Bounds(lower=-100, upper=100)
        simple_point = Point(x=np.array([10, 0, -10, 44, 90]))
        assert simple_point in bounds_object
    ...
    def test_point_in_bounds_one_invalid(self):
        ...
        """
        bounds_object = Bounds(lower=-100, upper=100)
        simple_point = Point(x=np.array([10, 0, -101, 44, 90]))
    ...
    def test_point_in_bounds_all_invalid(self):
        ...
        """
        bounds_object = Bounds(lower=30, upper=100)
        simple_point = Point(x=np.array([10, 0, -101, -10, 700]))
        assert simple_point not in bounds_object
    ...
    def test_random_point_in_bounds(self):
        ...
        """
        bounds_object = Bounds(lower=-1, upper=1)
        for _ in range(1000):
